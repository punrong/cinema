...
public class ScrollTop {
	...
	public void initializeOntheTop() {
		...
		ScrollImageListUpper.add(new ImageIcon("resource/theater.jpg"));
		ScrollImageListUpper.add(new ImageIcon("resource/Promotion Combo Set.jpg"));
		ScrollImageListUpper.add(new ImageIcon("resource/moviepopcorn.jpg"));
